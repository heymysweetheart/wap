...
function pageLoad() {
    type = document.getElementById("animationSelect").value;
    //Initialize the data
    frames = ANIMATIONS[type].split("=====");
    index = 0;
    var select = document.getElementById("animationSelect");
    select.onchange = changeAnimation;
    // startButton.onclick = showAnimation;
    // initValues;

    //Control
    var startButton = document.getElementById("startButton");
    startButton.onclick = setTimer;

    var stopButton = document.getElementById("stopButton");
    stopButton.onclick = showStatic;

    var fontControl = document.getElementById("fontControl");
    fontControl.onchange = changeFont;

    var speedControl = document.getElementById("speedControl");
    speedControl.onchange = changeSpeed;
}

function changeSpeed() {
    var speedControl = document.getElementById("speedControl");
    if(speedControl.checked) {
        interval = 125;
    } else {
        interval = 250;
    }
...
function changeFont() {
        document.getElementById("mainTextArea").style.fontSize = parseInt(document.getElementById("fontControl").value) + "px";
}
...
function showStatic() {
    ...
    textarea.value = ANIMATIONS[type];
}

function changeAnimation() {
    index = 0;
    type = document.getElementById("animationSelect").value
    frames = ANIMATIONS[document.getElementById("animationSelect").value].split("=====");
}
